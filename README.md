...
7. Call the ip-api under a refresh rate of 5 minutes. Use the same persisted data on duplicate IP scan requests that have a timestamp under 5 minutes from first scan.  
